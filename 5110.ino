// Code source tiré de http://devjoe.com/2012/12/26/playing-video-and-other-fun-things-on-the-nokia-3310-lcd-with-arduino-2/
...
void setup()   {
  ...
  text = "Servez-vous !";
  textWidth = text.length()*6+85; // Récupérer la taille du texte pour le for gloval
}
...
void loop() {
  for(int i=0; i<textWidth; i+=1) {
    ...
    display.display();
    delay(20); //Permet de ralentir le défilement du texte
  }
}
